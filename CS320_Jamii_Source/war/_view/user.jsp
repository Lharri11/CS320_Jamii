		...
		<header class="item header margin-top-0 header10" id="header10">
			...
			<div class="wrapper">
				...
				<nav role="navigation"
					...
					<div class="container">
						...
						<form class="search-collapse"
							action="${pageContext.servletContext.contextPath}/searchSite"
							method="post">
							<input type="text" id="searchText" placeholder="Search..."
								required> <input type="image" src="images/search.png"
						...
						<div id="navbar-collapse-02" class="collapse navbar-collapse">
							<ul class="nav navbar-nav navbar-right">
								<li class="propClone"><a href="#"><img
										src="images/user.png" class="tabIcon"></a></li>
								<li class="propClone"><a href="#"><img
										src="images/gear.png" class="tabIcon"></a></li>
				...
				<div>
							...
							<div id="pageInfo" style="height: 100px;">
								<table style="width: 100%;">
									...
									<c:forEach items="${groups}" var="group">
										...
										<input type="submit" value=${group.name } id="GeneralSubmit" name="Submit">
					...
					<div class="sidebar">
						<button onclick="toggleSideBar()" id="toggle" style="right: 0px;">Click
							Me</button>
						<div id="sideBar" style="right: -300px;">
							<ul class="list-unstyled groupList">
								<form id="GroupGet" method="post">
									<c:forEach items="${groups}" var="group">
										<li><td class="groupListItem"><input
												class="groupListItem" type="Submit" value=${group.name
												} id="Submit" name="Submit"></td></li>
									</c:forEach>
								</form>
							...
							<input type="Submit" value=${group.name } id="Submit"
								name="Submit">
						</div>
					</div>
				</div>
